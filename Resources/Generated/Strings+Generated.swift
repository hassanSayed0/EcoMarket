...
internal enum L10n {
  ...
  internal enum Home {
    internal enum Theme4 {
      /// Our EcoMarket App
      internal static let subtitle = L10n.tr("Localizable", "home.theme4.subtitle", fallback: "Our EcoMarket App")
      /// Wellcome,
      internal static let title = L10n.tr("Localizable", "home.theme4.title", fallback: "Wellcome,")
    }
  }
  internal enum Login {
    /// Continue with Apple
